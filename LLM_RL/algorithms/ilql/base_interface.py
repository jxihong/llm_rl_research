...
def ilql_loss(
    ...
    *, 
    ...
    # compute q loss
    q1_loss = (optax.l2_loss(q1sa_flat, jax.lax.stop_gradient(rewards.reshape(-1) + gamma * vns_selected)) * sa_mask).sum() / n
    q2_loss = (optax.l2_loss(q2sa_flat, jax.lax.stop_gradient(rewards.reshape(-1) + gamma * vns_selected)) * sa_mask).sum() / n
